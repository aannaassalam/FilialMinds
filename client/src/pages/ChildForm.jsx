  ...
  return (
    <>
      <div className="h-full w-screen text-black flex justify-center">
        <img className="absolute w-screen -z-10" src="/sakura-2446572_1280.jpg" alt="" />
        <div className="px-10 my-10 py-10 w-fit flex flex-col gap-y-10 items-center rounded-3xl shadow-2xl shadow-black bg-white">
          <h1 className="mb-4">Child's Details</h1>
          <div className="w-full flex justify-center" onChange={onChangeValue}>
