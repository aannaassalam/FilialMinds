...
const [question4, setQuestion4] = useState(0);
    ...
    return(
                ...
                <>
                    ...
                    <p className="text-2xl">13. My child tries to please me</p>
                ...
                <div className="q2 w-[45%] ">
                    <p className="text-2xl">14. My child feels that I treat him/her unfairly.</p>
                    <div className="options text-2xl flex justify-evenly flex-wrap">
                ...
                <div className="q3 w-[45%] ">
                    <p className="text-2xl">15. My child asks for my help when he/she really does not need help</p>
                    <div className="options text-2xl flex justify-evenly flex-wrap">
                ...
                <div className="q4 w-[45%] ">
                    <p className="text-2xl">16. It is easy to be in tune with what my child is feeling</p>
                    <div className="options text-2xl flex justify-evenly flex-wrap">
