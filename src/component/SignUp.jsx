...
function SignUp(){
    return(
        ...
        <div className="relative w-1/2 h-screen flex flex-col">
            ...
            <img src={kid2} className="w-full h-[90vh] rounded-2xl overflow-hidden object-cover" alt="picture" />
        </div>
        ...
        <div className="w-full flex flex-col max-w-[300px]">
            <h2 className="text-3x1 font- font-semibold mb-4 ">Sign in</h2>
            <p className="text-base mb-2">Welcome to <span className="text-[#664DD4]">GrowthWiz! </span> Please Sign In</p>
        </div>
        <div className="w-full flex flex-col">
            <label htmlFor="username">Username</label>
            <input className="w-full text-black px-2 py-2 my-2 border-b border-black outline-none focus:outline-none cursor-pointer rounded-md " type="text" placeholder="Enter your username" id="username" />
            ...
            <input className="w-full text-black px-2 py-2 my-2 border-b border-black outline-none focus:outline-none cursor-pointer rounded-md" type="password" placeholder="Confirm your password" id="password" />
        ...
        <div className="w-full flex items-center justify-between ">
            ...
            <p className="text-sm font-medium whitespace-nowrap underline underline-offset-2  cursor-pointer"></p>
        </div>
        <div className=" w-full flex flex-col my-4 ">
                <button className="w-full text-white my-2 bg-[#664DD4] font-semilbold rounded-md p-4 text-center items-center justify-center hover:border-2 hover:border-[#664DD4] hover:text-[#664DD4] hover:bg-white">
                    Create Account
                </button>
        ...
        <p className=" text-md absolute ">OR</p>

        </div>
        <div className="w-full">
            <p className="text-sm font-normal text-[#060606] mt-1">Already have an account? <span className="font-semibold underline underline-offset-2"> Login</span></p>
        </div>
